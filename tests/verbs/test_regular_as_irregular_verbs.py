...
def test_regular_verb_finite(test_verb: IrregularVerb, tense: Tense, mood: Mood,
...
def test_regular_verb_imperative(test_verb: IrregularVerb, tense: Tense, voice: Voice,
...
def test_regular_verb_infinitive(test_verb: IrregularVerb, tense: Tense, voice: Voice,
...
def test_regular_verb_participle(test_verb: IrregularVerb, tense: Tense, voice: Voice,
